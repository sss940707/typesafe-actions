...
{
  // @dts-jest:pass:snap -> TH.PayloadAction<"WITH_MAPPED_PAYLOAD", number> | TH.PayloadMetaAction<"WITH_MAPPED_PAYLOAD_META", number, string> | TH.EmptyAction<"WITH_TYPE_ONLY"> | { type: "VERY_DEEP_WITH_TYPE_ONLY"; } | TH.PayloadAction<"WITH_PAYLOAD", number> | TH.PayloadAction<"WITH_OPTIONAL_PAYLOAD", number | undefined> | TH.PayloadMetaAction<"WITH_PAYLOAD_META", number, string> | TH.EmptyAction<"FETCH_USER_REQUEST"> | TH.PayloadAction<"FETCH_USER_SUCCESS", { firstName: string; lastName: string; }> | TH.PayloadAction<"FETCH_USER_FAILURE", Error>
  ...
  // @dts-jest:pass:snap -> TH.PayloadAction<"WITH_MAPPED_PAYLOAD", number> | TH.PayloadMetaAction<"WITH_MAPPED_PAYLOAD_META", number, string> | TH.EmptyAction<"WITH_TYPE_ONLY"> | { type: "VERY_DEEP_WITH_TYPE_ONLY"; } | TH.PayloadAction<"WITH_PAYLOAD", number> | TH.PayloadAction<"WITH_OPTIONAL_PAYLOAD", number | undefined> | TH.PayloadMetaAction<"WITH_PAYLOAD_META", number, string> | TH.EmptyAction<"FETCH_USER_REQUEST"> | TH.PayloadAction<"FETCH_USER_SUCCESS", { firstName: string; lastName: string; }> | TH.PayloadAction<"FETCH_USER_FAILURE", Error> | undefined
